...
class SSD1306_I2C(object):
    ...
    def __init__(self, width, height, bus=1, address=SSD1306_I2C_ADDRESS_1):
        self._i2c = I2C(address, bus)
        self.width = width
        self.height = height
    ...
    def display(self):
        ...
        for i in range(0, len(self._buffer), 16):
            control = 0x40   # Co = 0, DC = 0
            self._i2c.write_block_data(control, self._buffer[i:i+16])
...
class SSD1306_128_64(SSD1306_I2C):
    def __init__(self, i2c_bus=1, i2c_address=SSD1306_I2C_ADDRESS_1):
        # Call base class constructor.
        super(SSD1306_128_64, self).__init__(128, 64, i2c_bus, i2c_address)
...
class SSD1306_128_32(SSD1306_I2C):
    def __init__(self, i2c_bus=1, i2c_address=SSD1306_I2C_ADDRESS_1):
        # Call base class constructor.
...
class SSD1306_96_16(SSD1306_I2C):
    def __init__(self, i2c_bus=1, i2c_address=SSD1306_I2C_ADDRESS_1):
        # Call base class constructor.
        super(SSD1306_96_16, self).__init__(96, 16, i2c_bus, i2c_address)
...
class OLED(object):
    def __init__(self):
        ...
        if len(addresses) == 0:
            log("No OLED found", level='WARNING')
        else:
