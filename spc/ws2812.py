...
class WS2812():
    ...
    def stop_loop(self, wait=False):
        self.stop_singal = True
        if wait:
            while self.isloop: # Wait for isloop to end
                time.sleep(0.001)
        self.stop_singal = False
    ...
    def hex_to_rgb(self, hex):
        try:
            ...
            self.log.error(f'color parameter error: \n  {e}')
    ...
    def display(self, style:str, color:str='#0a1aff', speed=50, brightness=255):
        ...
        try:
            ...
            self.log.error(f'LED strip parameter error: {e}')
        except Exception as e:
            self.log.error(f'LED display error: {e}')
...
# styles
        ...
        while True:
            ...
            for i in range(self.led_count):
                ...
                if self.stop_singal:
                    _stop_singal = True
                    break
            if self.stop_singa or _stop_singal:
                break
    ...
    def flow(self, color:list=[255, 255, 255], speed=50):
        ...
        while True:
            ...
            if self.stop_singal or _stop_singal:
                break
